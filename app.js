...
// 1. Question Database
const questions = [
  // E vs I (Energy Direction - 3 questions)
  {
    id: 1,
    type: "EI",
    question: "퇴근 후 지친 금요일 저녁, 주말의 시작을 어떻게 맞이하시나요?",
    answerA: { text: "불금인데 그냥 갈 순 없지! 핫플 모임이나 친구들과의 약속 장소로 향한다.", score: "E" },
    answerB: { text: "이불 밖은 위험해! 침대 누워 넷플릭스 켜고 나만의 평화로운 집돌이/집순이 타임.", score: "I" }
  },
  {
    id: 2,
    type: "EI",
    question: "SNS나 친구들과의 메신저 단톡방에서 나의 소통 스타일은?",
    answerA: { text: "하이텐션 주도자! 재밌는 짤방이나 이모티콘을 던지며 적극적으로 떠든다.", score: "E" },
    answerB: { text: "주로 눈팅하거나 간단한 리액션(ㅋㅋ, 하트 공감)만 남기고 조용히 있는다.", score: "I" }
  },
  {
    id: 3,
    type: "EI",
    question: "전화 통화 vs 카카오톡 문자 메신저, 당신이 생각하는 선호도는?",
    answerA: { text: "답답한 건 질색! 빠르게 용건을 처리하거나 수다를 떨 땐 역시 전화 통화가 최고.", score: "E" },
    answerB: { text: "갑작스러운 전화는 살짝 부담... 텍스트로 생각을 정리해서 보내는 메신저가 편하다.", score: "I" }
  },
  
  // S vs N (Information Processing - 2 questions)
  {
    id: 4,
    type: "SN",
    question: "'만약 내일 당장 로또 1등에 당첨된다면?'이라는 상상을 할 때 나의 행동은?",
    answerA: { text: "세금 공제액 계산, 즉시 구매할 부동산/주식 매물 확인 등 현실적인 재테크 계획을 세운다.", score: "S" },
    answerB: { text: "'내일 회사에 사표 멋지게 던지는 상황극'부터 시작해 우주 여행까지 온갖 영화 같은 시나리오를 쓴다.", score: "N" }
  },
  {
    id: 5,
    type: "SN",
    question: "친구가 \"나 어제 퇴근길 하늘에서 진짜 신기한 구름 봤어!\"라고 할 때 당신의 반응은?",
    answerA: { text: "\"오 진짜? 무슨 모양인데? 사진 찍은 거 있으면 보여줘!\" (구체적인 사실 확인)", score: "S" },
    answerB: { text: "\"구름 보니까 무슨 생각 들었어? 비 올라나? 지구 온난화 때문인가?\" (의미 부여와 공상)", score: "N" }
  },

  // T vs F (Decision Making - 3 questions)
  {
    id: 6,
    type: "TF",
    question: "친구가 \"오늘 회사에서 너무 탈탈 털리고 힘들어서 바로 연차 쓰고 쉬었어...\"라고 카톡했을 때 당신의 답장은?",
    answerA: { text: "\"헐 진짜 고생 많았어ㅠㅠ 얼마나 힘들었으면 연차까지 썼어... 맛있는 거 먹고 푹 쉬자!\" (정서적 공감)", score: "F" },
    answerB: { text: "\"무슨 일 있었는데? 연차 사유는 뭐라 썼어? 상사가 뭐라 안 해? 결재는 잘 났어?\" (인과 관계 파악 및 실질 대안)", score: "T" }
  },
  {
    id: 7,
    type: "TF",
    question: "퇴근 후 큰 맘 먹고 배달 음식을 시켰는데 배달 오류로 엉망이 되어 도착했다. 이때 당신의 대처는?",
    answerA: { text: "바쁘고 힘들 사장님 입장이 눈에 밟혀서 웬만하면 넘어가거나, 둥글게 1:1 메시지로 상황을 전달한다.", score: "F" },
    answerB: { text: "소중한 내 돈과 시간의 가치 훼손은 용납 불가! 증거 사진을 정확히 찍어 정당한 조치나 환불을 요청한다.", score: "T" }
  },
  {
    id: 8,
    type: "TF",
    question: "친구들과 핫한 논쟁거리나 시사 이슈로 의견 차이가 발생했을 때 나의 토론 태도는?",
    answerA: { text: "상대방의 기분이 나쁘지 않게 \"맞아, 네 말도 일리가 있어\"라며 조화롭게 분위기를 맞춘다.", score: "F" },
    answerB: { text: "\"그건 팩트가 아니야.\" 상대 감정과 무관하게 논리적 모순이나 사실관계를 조목조목 짚고 넘어간다.", score: "T" }
  },

  // J vs P (Lifestyle / Action - 2 questions)
  {
    id: 9,
    type: "JP",
    question: "주말 약속 당일 아침, 상대방이 \"정말 미안한데 약속 1시간만 미룰 수 있을까?\"라고 카톡을 보냈을 때?",
    answerA: { text: "이미 씻고 준비 다 마쳤는데 동선과 일정이 꼬여버려 속으로 엄청 킹받는다.", score: "J" },
    answerB: { text: "\"오히려 좋아!\" 카톡 보고 침대에 다시 누워 편안하게 스마트폰을 켜고 뒹굴거린다.", score: "P" }
  },
  {
    id: 10,
    type: "JP",
    question: "직장이나 학교에서 프로젝트/과제를 부여받았을 때 나의 작업 스타일은?",
    answerA: { text: "투두 리스트(To-Do)를 세밀하게 짜고 분량을 일별로 나누어 마감 한참 전에 완료해 둔다.", score: "J" },
    answerB: { text: "머릿속으로 대략적인 일정만 생각하고 미루다가, 마감 직전 벼락치기로 폭발적인 집중력을 낸다.", score: "P" }
  }
];
